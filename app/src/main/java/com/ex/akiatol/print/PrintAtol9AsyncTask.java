...
//import com.akitorg.mobilecash.R;
//import com.akitorg.mobilecash.activity.MainActivity;
//import com.akitorg.mobilecash.activity.PrintChequeFragment;
...
//
//import static com.akitorg.mobilecash.activity.PrintChequeFragment.PrintType.*;
...
//            if (printType != PrintChequeFragment.PrintType.ORDER_CASH
//                    && printType != ORDER_CARD
//                    && printType != PrintChequeFragment.PrintType.RETORDER_CASH
...
//            if (printType == PrintChequeFragment.PrintType.RETORDER_CASH || printType == RETORDER_CARD) {
...
//        fptr.create(context);
//
//        String fptr_settings = context.getSharedPreferences(MainActivity.FPTR_PREFERENCES,
//                Context.MODE_PRIVATE).getString(SettingsActivity.DEVICE_SETTINGS, null);
//
